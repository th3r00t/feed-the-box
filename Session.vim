...
nmap ,bb iimport pudb; pu.db
nmap ,v :vs
nmap ,s :mksession
nmap ,, :tabprev
nmap ,. :tabnext
nmap ,nt :tabnew
nmap ,vv :open /home/raelon/.vimrc
...
silent only
silent tabonly
cd ~/Downloads/builds/feed-the-box
...
exe 'vert 3resize ' . ((&columns * 147 + 89) / 179)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 86 - ((14 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
